...
final class DBService {
    ...
    static func setSideBarApplicaiton(width: CGFloat, appID: Int) {
    ...
    /// - Parameter appID: SideBar applicaiton의 ID
    /// - Returns: SideBar applicaiton의 width
    static func getSideBarApplicationWidth(of appID: Int) -> CGFloat {
        return UserDefaults.standard.object(forKey: "SideBarApp_\(appID)_width") as? CGFloat ?? 200
    }
}
